...
// ... (GlobalAtRiskWidget class lines 10-100 remain mostly same, check if I need to update imports only)
// Actually I need to replace from start to update imports.
                    ...
                    Row(
                      children: [
                        if (item.phoneNumber != null &&
                          ...
                          _ActionButton(
                            icon: Icons.call,
                            color: Colors.indigo, // Changed to Indigo
                            onTap: () => _makePhoneCall(item.phoneNumber!),
                          ),
                          const SizedBox(width: 8),
                          _ActionButton(
                            icon: FontAwesomeIcons.whatsapp, // Changed to FontAwesome
                            color: const Color(0xFF25D366), // WhatsApp Green
                            onTap: () => _openWhatsApp(item.phoneNumber!),
                            isFontAwesome: true, // Enable FaIcon
                          ),
                        ] else
                          Text(
